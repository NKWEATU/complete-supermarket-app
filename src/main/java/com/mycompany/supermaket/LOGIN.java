...
public class LOGIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("MY SUPERMARKET");

        jLabel8.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("EVERY PRODUCT IS AVAILABLE");
        ...
        jLabel5.setText("NKC-TECH        07080308505");
    ...
    try {
        if (role.equalsIgnoreCase("Admin")) {
            String query = "SELECT * FROM admintable WHERE admin_Id = ? AND adminPass = ?";
            ...
            String query = "SELECT * FROM sellers WHERE seller_Id = ? AND password = ?";
            pst = con.prepareStatement(query);
            pst.setString(1, userId);
            pst.setString(2, password);
            rs = pst.executeQuery();
